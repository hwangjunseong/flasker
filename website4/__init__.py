...
def delete_categories(id):
    ...
    for category in user_to_delete.categories:
        ...
        post_edit = Posts.query.filter_by(post_pic=category.category_pic).first()
        if post_edit:
                post_edit.post_pic = ""
...
def delete_category(id):
    ...
    post_edit = Posts.query.filter_by(post_pic=category_to_delete.category_pic).first()
